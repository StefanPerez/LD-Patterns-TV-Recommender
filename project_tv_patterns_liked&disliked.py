...
def get_pids_by_session_id(liked_programs, disliked_programs):    
    ...
    with open('source/to/file.csv') as f:
            ...
            for row in csv_reader:
                ...
                for i in range(0, len(disliked_programs)):
                    if row[0] == disliked_programs[i]:
                        pids_of_disliked_programs.append(row[1])

    pids_of_liked_and_disliked_programs = zip(pids_of_liked_programs,pids_of_disliked_programs)
    get_twitter_score(pids_of_liked_and_disliked_programs)
